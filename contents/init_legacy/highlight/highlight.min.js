...
function initHljs() {
    ...
    function E(e, {joinWith: t}) {
        ...
        return e.map((e=>{
            ...
            for (; i.length > 0; ) {
                ...
                "\\" === e[0][0] && e[1] ? r += "\\" + (Number(e[1]) + t) : (r += e[0],
                "(" === e[0] && n++)
            }
            return r
        }
    ...
    function V(e) {
        ...
        function n(s, o) {
            ...
            o && (s.begin || (s.begin = /\B|\b/),
            a.beginRe = t(a.begin),
            s.end || s.endsWithParent || (s.end = /\B|\b/),
            s.end && (a.endRe = t(a.end)),
            a.terminatorEnd = g(a.end) || "",
            s.endsWithParent && o.terminatorEnd && (a.terminatorEnd += (s.end ? "|" : "") + o.terminatorEnd)),
            s.illegal && (a.illegalRe = t(s.illegal)),
            s.contains || (s.contains = []),
            s.contains = [].concat(...s.contains.map((e=>(e=>(e.variants && !e.cachedVariants && (e.cachedVariants = e.variants.map((t=>r(e, {
                variants: null
            }, t)))),
            e.cachedVariants ? e.cachedVariants : q(e) ? r(e, {
                starts: e.starts ? r(e.starts) : null
            }) : Object.isFrozen(e) ? r(e) : e))("self" === e ? s : e)))),
    ...
    var te = (t=>{
        ...
        function m(e, t, n) {
            ...
            "object" == typeof t ? (i = e,
            n = t.ignoreIllegals,
            r = t.language) : (X("10.7.0", "highlight(lang, code, ...args) has been deprecated."),
        ...
        function E(e, t, r, s) {
            ...
            function h(e, t) {
                ...
                S = "") : e.beginScope._multi && (u(e.beginScope, t),
                S = "")),
                N = Object.create(e, {
                    parent: {
                        value: N
            ...
            function f(e) {
                return 0 === N.matcher.regexIndex ? (S += e[0],
                1) : (I = !0,
                0)
            }
            function b(e) {
            ...
            function w(i, s) {
                ...
                if ("begin" === m.type && "end" === s.type && m.index === s.index && "" === a) {
                    if (S += t.slice(s.index, s.index + 1),
                    !o) {
    ...
    var e = (()=>{
        ...
        function o(o) {
            ...
            const h = [].concat(N, y.contains)
              ...
              , k = {
                match: l.concat(/\b/, (O = [...c, "super", "import"],
                l.concat("(?!", O.join("|"), ")")), d, l.lookahead(/\(/)),
    ...
    var e = (()=>{
        ...
        return o=>{
            ...
            const v = [].concat(h, A.contains)
              ...
              , k = {
                match: l.concat(/\b/, (I = [...r, "super", "import"],
                l.concat("(?!", I.join("|"), ")")), b, l.lookahead(/\(/)),
                className: "title.function",
                relevance: 0
            };
            var I;
    ...
    var e = (()=>{
        ...
        function n(...a) {
            const t = (e=>{
                ...
                return "object" == typeof a && a.constructor === Object ? (e.splice(e.length - 1, 1),
                a) : {}
            }
            )(a);
